...
####################
    ...
    for person_data in alumni_list:
        ...
        if person_data['external-link'] != "":
            cards_tables["alum"] += '\t\t<span class="alum-name"><a href="' + person_data['external-link'] + '" target="_blank">' + person_data['name'] + ' <span class="icon-external"></span></a></span><br>\n\n';
        else:
