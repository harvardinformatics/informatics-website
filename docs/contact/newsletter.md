...
You will receive a **monthly newsletter** that will include all upcoming Informatics events for that month and links to other Harvard events/workshops related to bioinformatics and data science. 
