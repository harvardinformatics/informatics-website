...
{{ render_publications("annotation") }}
...
{{ render_publications("worm-genomes") }}
...
{{ render_publications("parasitic-plant") }}
...
{{ render_publications("scrna-methods") }}
...
{{ render_publications("scrna-ecology") }}
...
{{ render_publications("tube-worms") }}
...
{{ render_publications("transcriptome-assembly") }} 
...
{{ render_publications("rnaseq-assessment") }} 
...
{{ render_publications("coalescent-processes") }}
...
{{ render_publications("convergent-comparative") }}
...
{{ render_publications("peak-calling") }}
...
{{ render_publications("proteomics") }}
